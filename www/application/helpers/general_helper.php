...
function checkPermission($instance,$section=""){
	...
	if($chk == 0){
        ...
        $instance->load->view("/layouts/AdminLTE-3.2.0/error",$instance->data);          
		return false;
	}
	return true;
...
function DeleteButton(String $url="",String $pk="uuid",String $pk_value="",String $message="Are you sure you want to delete this record?",String $message_complete="Record has been deleted")
{
    ...
    $button = "<div class='btn btn-xs btn-flat btn-danger deleteAjax' ";
...
function DeleteButton2(String $table="",String $pk="uuid",String $pk_value="",String $message="Are you sure you want to delete this record?",String $message_complete="Record has been deleted", String $button_size="sm")
{
    ...
    $button .= "data-message-complete='{$message_complete}'";
    $button .= "data-".$pk."='$pk_value'>";
    $button .= "<i class='fa fa-trash'></i> <span class='button-label'>Delete</span></div>";
