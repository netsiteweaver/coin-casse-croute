        ...
        <div class="panel-body">
            <div class="col-md-3">
                <div class="form-group">
                    <label for="name"><i class="fa fa-info-circle"></i> Payment Mode</label>
                    <input id="name" type="text" class="form-control required" name="name" placeholder="" data-name="Payment Mode" value="" autofocus>
                </div>
            </div>
        </div>
        <div class="panel-body">
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="radio" name="attachment" id="attachment_yes" value="1">
                    <label for="attachment_yes">Yes</label>
                    <input type="radio" name="attachment" id="attachment_no" value="0" checked>
