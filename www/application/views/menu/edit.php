            ...
            <form id='resource' class="form-horizontal editing" action="<?php echo base_url('menu/save/' . $resource->id); ?>" method='post' name='resource_form'>
                ...
                <div class="box-body">
                    ...
                    <div class="form-group choose-icon <?php echo ($resource->visible == 0)?'hidden':'';?>">
                        ...
                        <div class="col-sm-4">
                            <input type="number" name="display_order" step='10' class="form-control required required numeric" id="min_stock" placeholder="Minum Stock Level" value='<?php echo $resource->display_order; ?>'>
                        </div>
                    </div>
                    <!-- Button --->
                    <div class="form-group">
