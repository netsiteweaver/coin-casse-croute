              ...
              <tr>
                ...
                <td class="actions">
                  <?php if($product->type != 'section'):?>
                    ...
                    <a href='<?php echo base_url('/menu/edit/' . $product->mid . '/'.$this->uri->segment(3)); ?>'><button class="btn btn-xs btn-flat btn-primary"><i class='fa fa-pencil'></i> Edit</button></a> 
                    <?php endif; ?>
                  <?php endif; ?>
                  
                  <?php if($perms['can_delete']): ?>
                  <a href='#' class='resource'><button data-id="<?php echo $product->mid; ?>" data-url="<?php echo base_url("menu/deleteAjax"); ?>" class="deleteAjax btn btn-xs btn-flat btn-danger"><i class='fa fa-trash-o'></i> Delete</button></a> 
                  <?php endif; ?>
