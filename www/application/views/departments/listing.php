                ...
                <table id="departments_listing" class="table">                    
                    ...
                    <tbody>
                        ...
                        <tr data-id="<?php echo $department->uuid;?>">
                            ...
                            <td>
                                <?php if($perms['edit']): ?>
                                <a href="<?php echo base_url("departments/edit/".$department->uuid); ?>"><div class="btn btn-xs btn-flat btn-primary"><i class="fa fa-edit"></i> Edit </div></a>
                                <?php endif; ?>
                                <?php if( ($perms['delete']) && ($department->id != 1) ) echo DeleteButton2('departments','uuid',$department->uuid); ?>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
