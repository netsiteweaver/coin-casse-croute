                ...
                <table id="tbl1" class="table table-border table-hover extended-bottom-margin">
                    ...
                    <tbody>
                        ...
                        <tr <?php echo ($_SESSION['user_id'] == $user->id)?' class="active"':''; ?>>
                            ...
                            <!-- <td class='text-center'><?php echo $user->is_sales?'<i class="fa fa-check"></i>':'<i class="fa fa-times"></i>';?></td> -->
                            <!-- <td class='text-center'><?php echo $user->is_delivery?'<i class="fa fa-check"></i>':'<i class="fa fa-times"></i>';?></td> -->
                            <!-- <td class='text-center'><?php echo $user->is_storekeeper?'<i class="fa fa-check"></i>':'<i class="fa fa-times"></i>';?></td> -->
