            ...
            <form id="add_user" action="users/save" method="post">
                <div class="card-body">
					...
					<div class="form-group">
						...
						<p class="notes">By selecting <b>No</b>, you will have to enter or generate a password, then
							give or send it to the user.</p>
						<div class="form-group">
						...
						<div class="form-group">
                            ...
                            <select class="form-control required" name="level" data-name="User Access Level">
