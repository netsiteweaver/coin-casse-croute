                        ...
                        <div class="col-md-12">
                            <nav>
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    <a class="nav-item nav-link active" id="nav-testing-tab" data-toggle="tab" href="#nav-posprinter" role="tab" aria-controls="nav-posprinter" aria-selected="false"><i class="fa fa-print"></i> POS Printer</a>
                                    <a class="nav-item nav-link" id="nav-rows_per_page-tab" data-toggle="tab" href="#nav-rows_per_page" role="tab" aria-controls="nav-home" aria-selected="true"><i class="fa fa-angle-down"></i> Rows Per Page</a>
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade" id="nav-rows_per_page" role="tabpanel" aria-labelledby="nav-rows_per_page-tab">
                                ...
                                <div class="tab-pane fade show active" id="nav-posprinter" role="tabpanel" aria-labelledby="nav-posprinter-tab">
                                    <div class="col-md-12">
                                        <p><i class="fa fa-print"></i> POS Printer</p>
                                        <div class="form-group">
                                            <label for="">Footer Message</label>
                                            <textarea name="footer_message" id="" rows="4" class="form-control"><?php echo $footer_message;?></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="total_items">Total Items or Rows</label>
                                            <select name="total_items" id="" class="form-control">
                                                <option value="rows" <?php echo ($total_items == 'rows')?'selected':'';?>>Total Rows</option>
                                                <option value="items" <?php echo ($total_items == 'items')?'selected':'';?>>Total Items</option>
                                                <option value="none" <?php echo ($total_items == 'none')?'selected':'';?>>Do Not Display</option>
                                            </select>
                                            <ul class="notes">
                                                <li><b>Total Items</b> will calculate the sum of the number of items in each row. </li>
                                                <li><b>Total Rows</b> will give only the number of rows.</li>
                                                <li><b>Do Not Display</b> will not display any these information</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
