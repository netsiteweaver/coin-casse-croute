                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <h3><i class="fa fa-sticky-note"></i> Contacts</h3>
                                ...
                                <div class="form-group ">
                                    <label for=""><i class="fa fa-clock"></i> Working Hours</label>
                                    <textarea name="working_hours" id="" class="form-control" rows="10"><?php echo $company->working_hours;?></textarea>
                                </div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-2">
                                        <img class='social-icon-32' src="./assets/images/social/facebook-64x64px.png" alt="">
                                    </div>
                                    <div class="col-md-8">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-2">
                                        <img class='social-icon-32' src="./assets/images/social/instagram-64x64px.png" alt="">
                                    </div>
                                    <div class="col-md-8">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-2">
                                        <img class='social-icon-32' src="./assets/images/social/youtube-64x64px.png" alt="">
                                    </div>
                                    <div class="col-md-8">
                            ...
                            <div class="form-group ">
                                <div class="row">
                                    <div class="col-md-2">
                                        <img class='social-icon-32' src="./assets/images/social/whatsapp-64x64px.png" alt="">
                                    </div>
                                    <div class="col-md-8">
