...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url("assets/css/pos.css?t=".date('ymdHis'));?>">
  <!-- LCD Fonts -->
  <link rel="stylesheet" href="<?php echo base_url("assets/fonts/Digital7/stylesheet.css");?>">
...
<span class="myloader d-none"></span>  
<!-- Site wrapper -->
<div class="wrapper">
  ...
  <audio id="quick-beep" src="<?php echo base_url("assets/audio/Quick-beep-sound-effect.mp3");?>" preload="auto"></audio>  
  <audio id="one-beep" src="<?php echo base_url("assets/audio/one-beep.mp3");?>" preload="auto"></audio>  

  <!-- More sounds -->
  <audio id="swing" src="<?php echo base_url("assets/audio/swing-whoosh-110410.mp3");?>" preload="auto"></audio> 

  <!-- Navbar -->
  <?php //$this->load->view("shared/AdminLTE-3.2.0/topbar",$this->data);?>
  <!-- /.navbar -->

  <?php //$this->load->view("shared/AdminLTE-3.2.0/leftsidebar",$this->data);?>
  ...
  <div class="content-wrapper" style="margin-left:0px !important;">
    ...
    <section class="content-header">
      ...
      <?php $this->load->view("shared/AdminLTE-3.2.0/alerts",$this->data);?>
        <div class="row mb-2">
          <div class="col-sm-5">
            <h1><?php echo isset($page_title)?$page_title:"&nbsp;"; ?></h1>
          </div>
          <div class="col-sm-2" id="turret_display">0.00</div>
          <div class="col-sm-5">
  ...
  <?php //$this->load->view("shared/AdminLTE-3.2.0/footer",$this->data);?>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <input type="text" id="modalUsername" class="form-control" name="modal-email" placeholder="Username or Email">
        </div>
        <div class="form-group">
          <label for="modalPassword">Password</label>
          <input type="password" id="modalPassword" class="form-control" name="modal-password" placeholder="Password">
        </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="fa fa-times"></i> Close</button>
