...
<body>
  <div class="container" id='elem'>
    ...
    <div class="row">
      ...
      <div class="row">
        <div class="col-xs-12">
          <a href='<?php echo base_url("sales/listing?".$_SERVER['QUERY_STRING']);?>'><div class="btn btn-sm btn-warning"><i class="fa fa-chevron-left"></i> Back</div></a>
          <a href='<?php echo base_url("sales/pdf/".$invoice->uuid);?>'><div class="btn btn-sm btn-danger pdf"><i class="fa fa-file-pdf-o"></i> PDF</div></a>
          <div class="btn btn-sm btn-info png"><i class="fa fa-image"></i> PNG</div>
          <div class="btn btn-sm btn-default print"><i class="fa fa-print"></i> Print</div>
        </div>
      </div>
      <footer></footer>
  </div>
