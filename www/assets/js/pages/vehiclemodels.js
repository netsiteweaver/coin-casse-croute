jQuery(function(){
    ...
    tableSort('#vehiclemodels_listing','vehicle_models','id','display_order');

    Search('searchText','vehiclemodels_listing');
    ...
    $('body').on('click', '.edit-block', function () {
        ...
        let url = base_url + 'vehiclemodels/blockcontent/' + pageBlockID;
...
{   var model = document.getElementById('model').value;
    model = model.replace(/[^a-zA-Z0-9]+/g,'-').toLowerCase();
    console.log(model);
    ...
    var url = base_url+"ajax/misc/Check_Slug_VehicleModels/"+model+"/"+uuid;
